...
const Form2 = () => {
  return (
    <div
      className="w-[95%] min-h-screen mx-auto flex justify-center items-center py-10 "
      data-aos="fade-up"
    >
      <div className=" w-[100%] py-5 bg-gray-200 sm:bg-white rounded-md flex flex-col sm:flex-row">
        ...
        <div className=" w-full h-fit py-5 sm:py-10 sm:mx-5 sm:w-1/2 sm:min-h-[100%] flex flex-col items-center justify-center bg-gray-200 rounded-md">
          ...
          >
            ...
            />
            <select
              className=" hidden ring mb-[3px] ring-white w-full text-xs text-gray-400  rounded-sm px-4 py-2 outline-none focus:ring-2 focus:ring-black"
              name="country"
              class="form-control"
              id="country"
            >
