    ...
    <>
      <div className=" p-4 lg:p-16">
        ...
        <div class="grid grid-cols-1 md:p-8 gap-x-1 gap-y-1  md:grid-cols-2">
          <div className=" h-screen w-full bg-[url('../public/Images/eau.webp')] bg-fixed  bg-center md:bg-left bg-no-repeat"></div>
          <div className=" p-2 lg:p-12">
            <div className=" text-slate-700 ">
              <ul className="leading-8 my-2  ">
                <li
                  className=" py-4 lg:my-2 border-b-[1px] border-solid border-black"
                  data-aos="fade-up"
                  onClick={() => router.push("/industries/ArVrservices")}
                >
                ...
                <li
                  ...
                  data-aos="fade-up"
                  onClick={() =>
                    router.push("/industries/cloudcomputingsolutions")
                  }
                >
                  <h1 className="font-medium text-2xl lg:text-3xl cursor-pointer">
                    Cloud Computing <br />
                ...
                <li
                  ...
                  data-aos="fade-up"
                  onClick={() =>
                    router.push("/industries/customsoftwaredevelopment")
                  }
                >
                  <h1 className="font-medium text-2xl lg:text-3xl cursor-pointer">
                ...
                <li
                  ...
                  data-aos="fade-up"
                  onClick={() =>
                    router.push("/industries/cybersecurityservices")
                  }
                >
                  <h1 className=" font-medium text-2xl lg:text-3xl cursor-pointer">
                ...
                <li
                  ...
                  onClick={() =>
                    router.push(
                      "/industries/DataAnalyticsandBusinessIntelligence"
                    )
                  }
                >
                  <h1 className="font-medium text-2xl lg:text-3xl cursor-pointer">
                ...
                <li
                  ...
                  data-aos="fade-up"
                  onClick={() =>
                    router.push("/industries/itconsultingservices")
                  }
                >
                  <h1 className="font-medium text-2xl lg:text-3xl cursor-pointer">
                ...
                <li
                  ...
                  data-aos="fade-up"
                  onClick={() =>
                    router.push("/industries/ITTrainingandEducation")
                  }
                >
                  <h1 className=" font-medium text-2xl lg:text-3xl cursor-pointer">
                ...
                <li
                  ...
                  data-aos="fade-up"
                  onClick={() =>
                    router.push("/industries/ITsupport&managedservices")
                  }
                >
                  <h1 className=" font-medium text-2xl lg:text-3xl cursor-pointer">
